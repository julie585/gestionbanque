...
@if($val == "epargne")
    ...
    ?>
                ...
                <div>
                    ...
                    <select onchange="ecran($(this).val(),'idlistecompte','superieur.contenu.destinatairefinepargne')" class="form-control show-tick"  name="clientexp" >
                        <option></option>
...
@if($val == "courant")
    ...
    <div>
        <label for="clients">Nom du Client</label>
        <select onchange="ecran($(this).val(),'idlistecompte','superieur.contenu.destinatairefincourant')" class="form-control show-tick"  name="clientexp" >
            <option></option>
            @foreach($client as $client)
                <option value="{{ $client->id }}" >{{$client->nom}}  {{$client->prenom}} </option>
            @endforeach
