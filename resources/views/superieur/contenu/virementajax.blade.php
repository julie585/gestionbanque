...
@if($val == "epargne")
    ...
    ?>
                ...
                <div>
                    ...
                    <select onchange="ecran($(this).val(),'idlistedestinataire','superieur.contenu.virementfinepargne')" class="form-control show-tick"  name="clientdes" >
                        <option></option>
...
@if($val == "courant")
    ...
    <div>
        <label for="clients">Nom du Client</label>
        <select onchange="ecran($(this).val(),'idlistedestinataire','superieur.contenu.virementfincourant')" class="form-control show-tick"  name="clientdes" >
            <option></option>
            @foreach($client as $client)
                <option value="{{ $client->id }}" >{{$client->nom}}  {{$client->prenom}} </option>
            @endforeach
