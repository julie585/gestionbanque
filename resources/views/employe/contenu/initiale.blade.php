...
@section('table')
    ...
    <div class="body">
        ...
        <div class="row">
            @include('superieur/layout/pannel', ['color' => 'blue', 'icone' => 'person', 'url' => '../employe/listeclient',  'name' => 'Clients','nbr' => $nbrecli])
            @include('superieur/layout/pannel', ['color' => 'cyan', 'icone' => 'layers', 'url' => '../employe/retrait',  'name' => 'Nombre Total de Retrait','nbr' => $nbreret])
            @include('superieur/layout/pannel', ['color' => 'cyan', 'icone' => 'layers', 'url' => '../employe/versement',  'name' => 'Nombre Total de Versement','nbr' => $nbrever])
            @include('superieur/layout/pannel', ['color' => 'cyan', 'icone' => 'layers', 'url' => '../employe/virement',  'name' => 'Nombre Total de Virement','nbr' => $nbrevir])
