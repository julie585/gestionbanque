...
r.ext.buttons.copyHtml5={className:"buttons-copy buttons-html5",text:function(a){return a.i18n("buttons.copy","Copier")},action:function(a,b,d,c){var a=L(b,c),f=a.str,d=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c.customize&&(f=c.customize(f,c));c=g("<textarea readonly/>").val(f).appendTo(d);if(j.queryCommandSupported("copy")){d.appendTo(b.table().container());c[0].focus();c[0].select();try{var e=j.execCommand("copier");d.remove();if(e){b.buttons.info(b.i18n("buttons.copyTitle",
"Copier dans le presse-papier"),b.i18n("buttons.copySuccess",{1:"Copie d une ligne dans le presse-papier",_:"Copie %d ligne dans le presse-papier"},a.rows),2E3);return}}catch(h){}}e=g("<span>"+b.i18n("buttons.copyKeys","Appuyer <i>ctrl</i> et <i>⌘</i> + <i>C</i> pour copier les données de la table<br>dans le presse-papier de votre systeme.<br><br>Pour avorter cette action, cliquer sur ce message ou bien appuyer sur le bouton echaper.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Sauvegarder  dans le presse-papier"),e,0);c[0].focus();c[0].select();var l=g(e).closest(".dt-button-info"),i=function(){l.off("click.buttons-copy");
