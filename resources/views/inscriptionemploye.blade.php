...
<div class="row">
    <div class="col-md-6 col-sm-12 col-lg-6 col-md-offset-3">
        <div class="panel panel-primary">
            <div class="panel-heading">Inscription d' un employé</div>
            <div class="panel-body">
                <form name="myform" action="{!! url('/employe/register') !!}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group">
                        <label for="superieur">Code du Supérieur</label>
                        <input id="superieur" name="superieur"  class="form-control" type="number" required >
                ...
                <form name="myform" action="{!! url('/superieur/home') !!}" method="get">
