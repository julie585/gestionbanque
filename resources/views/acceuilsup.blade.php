...
<div id="wrapper">
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right navbar-nav">
            <li><a href="/home"><strong> Accueil </strong></a></li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ url('/superieur/logout') }}" onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">
                            <i class="material-icons">input</i>Déconnection</a>

                        <form id="logout-form" action="{{ url('/superieur/logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                    </li>
                </ul>
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <a href="{{ url('/superieur/logout') }}"onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ url('/superieur/listeclient ') }}">Clients</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/inscriptionclient ') }}">Inscription</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ url('/employe/register ') }}">Inscription</a>
                        </li>
                ...
                <li >
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ url('/superieur/creation ') }}">Creation du Compte</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/versement ') }}">Versement</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/retrait ') }}">Retrait</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/virement') }}">Virement</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ url('/superieur/liste') }}">
                        <i class="material-icons">home</i>
                        <span>Liste des informations</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/superieur/info ') }}">
                        <i class="material-icons">home</i>
                        <span>Poster des informations</span>
                    </a>
                </li>

                <li class="special">Analyse et Parametrage</li>
                ...
                <li >
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ url('/superieur/compte ') }}">Consultation Compte</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/listeemployes ') }}">Listes des employés</a>
                        </li>
                        <li>
                            <a href="{{ url('/superieur/consultclient') }}">Listes des Clients</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{ url('/superieur/modifcompte') }}">MODIFICATION DU COMPTE</a>
                        </li>
