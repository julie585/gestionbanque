...
@section('table')
    ...
    @endif
    <form role="form" method="POST" action="{{ url('/employe/virement') }}">
    ...
    <div class="body">
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                ...
                <select onchange="ecran($(this).val(),'idlisteentite','employe.contenu.destinataireajax')" class="form-control show-tick" name="typecompteexp">
                    <option></option>
    ...
    <div class="body">
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <label for="nom">Type de compte</label>
                <select onchange="ecran($(this).val(),'iddestinataire','employe.contenu.virementajax')" class="form-control show-tick" name="typecomptedest">
                    <option></option>
