...
@section('head')
    ...
    $numeroexp = \Illuminate\Support\Facades\DB::table('compteepargne')
                ->where('client_id','=', $val)
                ->select('compteepargne.numero')
                ->first();
...
@stop
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <h4>{{ $numeroexp->numero }}</h4>
                            <input type="hidden" name="numero" value="{{ $numeroexp->numero }}">
