...
@if($val == "epargne")
    ...
    <div class="body">
        ...
        <form role="form" method="POST" action="{{ url('/superieur/epargne') }}">
...
@if($val == "courant")
    ...
    <div class="body">
        ...
        <form role="form" method="POST" action="{{ url('/superieur/courant') }}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <legend >
                <STRONG> CLIENT </STRONG>
            </legend>
            ...
            <div class="body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <a class="btn bg-special waves-effect m-b-15 pull-right" role="button"  href="/tabassociation">
                            RETOUR
                        </a>
                    </div>
