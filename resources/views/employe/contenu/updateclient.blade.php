...
@section('table')
    ...
    <div class="body">
        ...
        <form role="form" method="POST" action="{{ url('/employe/modify', $id= $client->id) }}">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" id="password" name="password" placeholder="Nouveau Mot de Passe" required>
                        </div>
                    </div>
                </div>
